...
search methods and outputs the book ID, the name of the book, the amount purchased, and the total cost. If the user selects '3' or '4', then the computer generates 1000 random numbers and
sorts them out in ascending order using two different search methods. The computer also outputs the amount of time it takes to generate the sort in seconds.
*/
#include <iostream>
#include <iomanip>
#include <time.h>
